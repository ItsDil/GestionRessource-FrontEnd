...
// setTimeout( () => {
    var App = function () {
      ...
      var toggleFunction = {
        ...
        //         const ifStarterKit = document.body.getAttribute('page') === 'starter-pack' ? true : false;
        //         if (ifStarterKit) {
        //           document.querySelector('.navbar-logo').setAttribute('src', 'https://designreset.com/cork/html/src/assets/img/favicon.ico')
        //         } else {
      ...
      var inBuiltfunctionality = {
        mainCatActivateScroll: function () {
          ...
          if (document.querySelector('.menu-categories')) {
            ...
            let ps = new PerfectScrollbar('.menu-categories', {
              wheelSpeed: .5,
              swipeEasing: !0,
        ...
        notificationScroll: function () {
          ...
          if (document.querySelector('.notification-scroll')) {
            let notificationS = new PerfectScrollbar('.notification-scroll', {
              wheelSpeed: .5,
              swipeEasing: !0,
              minScrollbarLength: 40,
              maxScrollbarLength: 300
